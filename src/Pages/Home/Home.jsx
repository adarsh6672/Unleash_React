    ...
    <>
        ...
        <div className='block md:hidden px-5 text-center  text-black h-72  w-full'>
          ...
          <div className='flex justify-center '>
            <h1 className='font-bold text-3xl text-center border-b-4 border-orange-400 pb-2  max-w-lg mt-8'>Choose Help . Not Suffering</h1>
          </div>
          <div className='sm:grid grid-cols-12 gap-4 mt-20'>
            ...
            <div className='col-span-6  px-10 '>
                <h1 className='font-bold text-2xl '>Counselling Therapy Sessions With Licensed & Verified Experts</h1>
                <h1 className='text-xl font-medium text-gray-600 pt-5'>Highly qualified team of some of the best names in psychology 
