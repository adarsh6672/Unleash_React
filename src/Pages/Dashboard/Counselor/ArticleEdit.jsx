...
function ArticleEdit() {
    ...
    const setStates = () => {
        if (data) {
            ...
            setTitle(data.title)
            setRelatedTo(parseInt(data.relatedTo))
    ...
    const handlePost = async () => {
        ...
        if (true) {
            ...
            formData.append('articleId',parseInt(data.id))

            AxiosInstance.put('article/edit-article', formData)
                .then(res => {
                    console.log(res)
                    notify();
                    navigate(-1)
                    ...
                    <div id='section2' className=" mt-6 px-5 lg:mt-0 rounded shadow bg-white">
                        ...
                        <form>
                                ...
                                <div>
                                    <div className="md:flex mb-6 ">
                                        ...
                                        <div className='md:w-3/4 '>
                                            <img src={data.image} alt="" className='object-cover rounded-xl w-full h-52 mb-5' />
                            ...
                            <div className="md:flex mb-6">
                                ...
                                <div className="md:w-3/4">
                                    <select onChange={e => setRelatedTo(e.target.value)} value={relatedTo} className="form-select block w-full focus:bg-white rounded-lg" id="my-select">
